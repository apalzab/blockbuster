...
# mpo3 = MoviePurchaseOption.create(movie_id: movie1.id, purchase_option_id: p3.id, active: true)
# mpo4 = MoviePurchaseOption.create(movie_id: movie1.id, purchase_option_id: p4.id, active: true)
# mpo5 = MoviePurchaseOption.create(movie_id: movie1.id, purchase_option_id: p5.id, active: true)
# mpo6 = MoviePurchaseOption.create(movie_id: movie1.id, purchase_option_id: p6.id, active: true)
...
# # # User
user = User.create(nickname: 'bender', email: 'email@example.com', password: 'password', password_confirmation: 'password')
